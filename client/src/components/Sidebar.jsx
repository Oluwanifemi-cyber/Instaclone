      ...
      <div className="flex flex-col min-h-screen justify-between py-6  px-4 ">
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Notications />
            <CreatePost />
            <NavLink to={`/profile/${user?.username}`} className="tooltip tooltip-right"
            data-tip="Profile"
            >
              {({ isActive }) => (
                <span
        ...
        <div className="dropdown dropdown-top">
          <div className="m-1 flex items-center cursor-pointer"role="button"
          tabIndex={(0)}
          >
          ...
          <li>
            <NavLink to="/settings">
            <i className="ri-settings-line text-2xl">Settings</i>
            </NavLink>
          </li>
          <li>
